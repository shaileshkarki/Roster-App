...
function Wages({}) {
    ...
    } = useAPI("http://localhost:9000/wages/uniqueroles");
    ...
    } = useAPI("http://localhost:9000/wages/eachrosterswagesbyperson");
    ...
    const handleTotalRoleWagesRosterOne = async (e) => {
        ...
        const response = await axios.get(
            `http://localhost:9000/wages/uniqueroles`,
            {}
        );
        console.log(response.status);
        // if (response.status === 200) {
    ...
    const handlegetGachRosterWeekWagesByEachPersonAndRole = async (e) => {
        e.preventDefault();
        const response = await axios.get(
            `http://localhost:9000/wages/eachrosterswagesbyperson`,
            {}
        );
        console.log(response.status);
        // if (response.status === 200) {
                ...
                <MDBRow center>
                    <MDBDropdown>
                        ...
                        <MDBDropdownMenu basic>
                            {rosters.map((roster) => (
                                <MDBDropdownItem
                                    href={`/viewWeeklyWages/${roster.roster_id}`}
                                >
                                    {roster.title}
                                </MDBDropdownItem>
                            ))}
