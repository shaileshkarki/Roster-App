...
function StaffForm({ data }) {
    ...
    const handleRemoveStaff = async (e) => {
        ...
        const response = await axios.put(`${HOST_URL}staff/remove/${staffId}`, {
            removedStaffMember: {
                staffId,
                firstname,
                lastname,
    ...
    const handleUpdateSubmit = async (e) => {
        ...
        const isEmailOk = await axios.get(
            `${HOST_URL}staff/email/${email}/${staffId}`
        );
        ...
        const response = await axios.put(`${HOST_URL}staff/${staffId}`, {
            updatedStaffMember: {
                staffId,
                firstname,
                lastname,
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(`${HOST_URL}staff`, {
                newStaffMember: {
                    firstname,
                    lastname,
                    address,
